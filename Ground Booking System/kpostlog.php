...
<body>
    <div class = "loginBox">
<form action="kturnreg.php" method="post" name="GroundBooking" onsubmit="return(validate());">
...
<td>Date</td>
<td><input type="date"  min="2017-05-11" name="dt"  min="2017-06-11" max="2020-06-11"></td>
<td>Days</td>
...
<td>Amount</td>
<td name="amount" id="amount" size="30" value="100" >80</td>
